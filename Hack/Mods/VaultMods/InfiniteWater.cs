...
{
    class InfiniteWater : Module
    {
        public InfiniteWater() : base("Infinite Water", KeyCode.None, Categories.mVault, GuiNames.Toggle)
        {
        }
        ...
        public override void onUpdate()
        {
            ...
            MonoSingleton<Vault>.Instance.Storage.AddResource(new GameResources(EResource.Water, 1337));
        }
    }
}
